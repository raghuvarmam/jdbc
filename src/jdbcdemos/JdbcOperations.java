...
public class JdbcOperations {
	...
	public static void main(String[] args) throws Exception {
		...
		int count2 = stmt.executeUpdate("UPDATE employee SET esal=4000 WHERE eid = 2");
		...
		int count3 = stmt.executeUpdate("DELETE FROM employee  WHERE eid = 1");
		...
		int count5 = stmt.executeUpdate("UPDATE employee SET rank = 1 WHERE eid = 2");
